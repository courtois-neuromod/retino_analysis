...
#workon retino_analysis #workon alias doesn't work in bash script env
...
OUTDIR="${RUNDIR}/results/npythy/sub-${SUB_NUM}/slicetimed"
INDIR="${RUNDIR}/results/fs/sub-${SUB_NUM}/slicetimed"
